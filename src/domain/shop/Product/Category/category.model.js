...
productCategorySchema.statics.isNameTaken = async function (name, excludeCategoryId) {
...
productCategorySchema.statics.buildTree = async function () {
...
const Category = mongoose.model('Product_Category', productCategorySchema);
